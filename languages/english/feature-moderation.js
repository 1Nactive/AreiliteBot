exports.translations = {
	...
	moderation: {
		'automod': '',
		//mods
		'fs': 'Please do not flood the chat',
		'sl': 'Do not spam links please',
		's': 'Please do no spam the chat',
		'f': 'Please do not flood the chat',
		'possible': 'You are a possible spammer',
		'caps': 'Please do not abuse caps',
		'stretch': 'Please do not strech characters',
